        ...
        <div class="container">
            <h3>Principais áreas:</h3>
                <ul class="list-inline">
                    <li><span class="label label-success">PFTO</span></li>
                    <li><span class="label label-success">Banco de Dados</span></li>
                    <li><span class="label label-success">HTML</span></li>
            ...
            <br>
            <br>
            <h3>Últimas dúvidas postadas</h3>
            <div class="row">
